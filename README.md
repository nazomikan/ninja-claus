...
~~~sh
# getting the code
git clone git@github.com:nko4/kusattamikan.git && cd ./kusattamikan/

# developing
npm install
npm start

# deploying (to http://kusattamikan.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@kusattamikan.2013.nodeknockout.com
ssh root@kusattamikan.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@kusattamikan.2013.nodeknockout.com
ssh -i ./id_deploy root@kusattamikan.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/kusattamikan" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
